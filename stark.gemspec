...
Gem::Specification.new do |s|
  s.name = "stark"
  s.version = "0.8.0.20130422182659"
  ...
  s.test_files = ["test/test_client.rb", "test/test_helper.rb", "test/test_marshal.rb", "test/test_parser.rb", "test/test_ruby.rb", "test/test_server.rb", "test/test_spark.rb"]
